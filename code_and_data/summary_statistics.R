...
#########################################################################
# create a new  for by study, by environmental variable, direction of relationship for high quality and significant relationships
addWork(wb, "study_envrnm_direction_select")
...
################################################################
#  by study type and tested mechanisms of influence
addWork(wb, "study_mechanism_tested")
...
################################################################
#  by study type and assumed mechanisms of influence
addWork(wb, "study_mechanism_assumed")
...
################################################################
#  by study type and all mechanisms of influence
addWork(wb, "study_mechanism_all")
